...
\begin{description}
	\item \emph{Basic belief}: a belief that is not supported by any other beliefs
	
	\item[Foundationalism]  In a good belief system, some beliefs are basic; and every other belief is supported by those basic beliefs
	
	\item \emph{The method of doubt}:  go through all your beliefs, and throw away all those that can be doubted.  The remaining beliefs are certain; they are the basic beliefs that support all others
	
	\item[Descartes's Foundationalism]  Foundationalism $+$ basic beliefs must be certain
\end{description}
